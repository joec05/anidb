import 'package:anime_list_app/searched_animes.dart';
import 'package:anime_list_app/searched_mangas.dart';
import 'package:anime_list_app/searched_characters.dart';
                        ...
                        builder: (dialogContext) {
                          return AlertDialog(
                            ...
                            content: Column(
                              ...
                              children: [
                                Text('Minimum 4 characters needed!!!', style: TextStyle(fontSize: defaultTextFontSize)),
                                SizedBox(
